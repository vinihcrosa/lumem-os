...
| [tasks.md](prd/pull-request-status/tasks.md) | **18 tasks em 7 fases** — as 16 do plano mais a P14, que a Q3 e a Q4 abriram. A fase 1 (E1–E3) saiu para a `worktree-first-tab`; a 2 é o spike |
...
| [tasks.md](prd/second-agent/tasks.md) | 16 tasks em 3 fases — **13 fechadas**: catálogo e consumo entregues; o login (fase 2) é o que falta, e o desenho dele já está feito |
