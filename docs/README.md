...
| [A credencial do tracker vem do ambiente, e o Lumem continua não guardando segredo](adr/2026-09-13-1531-tracker-credentials-come-from-the-environment.md) | 2026-09-13 | `security` |

Nenhum dos nove tem `supersedes` — a cadeia ainda não foi exercitada. É o gatilho para os gates
