...
| **P6** | O número do timeout de silêncio (120 s) foi escolhido no desenho, não medido | fecha na C7, que mede quanto tempo o git fica calado entre fases num clone grande de verdade e escreve o número aqui |
