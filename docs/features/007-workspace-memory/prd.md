...
| **A Anthropic reativar a separação de pools de billing** | anunciada para 15/jun/2026 e cancelada no mesmo dia, com promessa de retrabalhar e avisar antes (§9.2 do estudo) | `transport` continua sendo coluna: voltar uma sessão para PTY — o lado *first-party*, poupado — é config, não refactor<br><br>**Nota, 2026-09-24:** voltar agente para PTY deixou de ser configuração ([ADR de 2026-09-24](../../adr/2026-09-24-1620-agent-is-always-acp.md)); agente é sempre ACP ([`033`](../033-acp-only-agents/prd.md)). |
