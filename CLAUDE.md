...
A [`033`](docs/features/033-acp-only-agents/prd.md) encerra o agente em PTY, cria a worktree já
compondo o primeiro prompt e abre novos agentes numa aba rascunho. A discovery mediu as opções,
