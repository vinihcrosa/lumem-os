  ...
  create: publicProcedure
    .input(
      z.object({
        ...
        /**
         * Required: every configuration is an ACP adapter (`033` F1.1), and one
         * with no pinned version cannot be launched reproducibly. Present here
         * so the API can do everything the client can (PRD §7).
         */
