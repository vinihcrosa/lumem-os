...
import { useCheckoutChanges, type ChangeRef, type ChangeStatus } from "./useCheckoutChanges.js";
import { CHANGES_PREFIX, FILES_PREFIX } from "../../lib/queryKeys.js";
import {
  usePrDismissal,
  usePrRefresh,
  usePullRequest,
} from "../pull-request/index.js";
import type { RunDockState } from "./useRunDock.js";
import { useFileTree } from "./useFileTree.js";
import { useProposals } from "../memory/index.js";
import { useOpenFiles } from "../../hooks/useOpenFiles.js";
import { useScopeIds } from "./useScopeIds.js";
import type { Scope } from "./useSessionsByScope.js";
import { ChangesTab } from "./ChangesTab.js";
import { ChecksTab, checksBadge } from "../pull-request/index.js";
import { FileTree, NewInRoot } from "./FileTree.js";
import { MemoryPanel } from "../memory/index.js";
import { PrBar } from "../pull-request/index.js";
