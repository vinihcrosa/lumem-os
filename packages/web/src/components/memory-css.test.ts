...
/**
 * A auditoria de porte do painel de memória, nas duas direções.
 *
...
const INTERPOLATED = ["mem-tab--active", "mem-stat--warn"];
...
const BORROWED = new Set([
  ...
  "btn",
  "focus-ring",
  // O anel de foco e o botão do painel direito.
  "n",
  "l",
  "hint",
]);

describe("toda classe que o painel de memória pede existe", () => {
  const available = defined(stylesheet);

  it("define toda classe literal que o painel usa", () => {
