...
beforeEach(() => {
  vi.resetAllMocks();
  // `resetAllMocks` apaga a implementação, inclusive os defaults do mock — e a
  // tela do workspace consulta o consumo no `mount`. Sem isto o `App` renderiza
  // o banner de erro de uma query que este teste nunca pediu, e ele vira o
  // primeiro `role=alert` da tela.
  installTrpcDefaults();
